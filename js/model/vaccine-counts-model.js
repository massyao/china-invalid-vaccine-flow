...
VaccineCountsModel.prototype._initializeDataStructures = function(data) {
  ...
  this.globalVaccines = this._prepareYearsMonthsArray(function() { return { count: 0 }; });

  data.forEach(function(item) {
    if (!this.arrivedVaccinesToCountry[item.ac]) {
      this.arrivedVaccinesToCountry[item.ac] = this._prepareYearsMonthsArray(function() { return { count: 0 }; });
    }
